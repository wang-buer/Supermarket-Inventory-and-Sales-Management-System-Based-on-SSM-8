...
public class ShangpinxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShangpinxinxiEntity shangpinxinxi, 
                @RequestParam(required = false) Double shoujiastart,
                @RequestParam(required = false) Double shoujiaend,
		HttpServletRequest request){

        EntityWrapper<ShangpinxinxiEntity> ew = new EntityWrapper<ShangpinxinxiEntity>();
                if(shoujiastart!=null) ew.ge("shoujia", shoujiastart);
                if(shoujiaend!=null) ew.le("shoujia", shoujiaend);
